    ...
    <div className="map">
      <Map
        ...
        {wilayas.map((wilaya, index) => {
          wilaya.confirmed = Math.floor(Math.random() * 99 + 1);
          if (wilaya.confirmed && wilaya.confirmed > 0)
            return (
              <Circle
                key={wilaya.code}
                center={{
                  lat: wilaya.coordinates[0],
                  lng: wilaya.coordinates[1]
                }}
                fillColor={getGradientColor(
                  "#ff6f00",
                  "#FF0000",
                  normilize(
                    Math.log10(wilaya.confirmed),
                    Math.log10(/*maxWilaya.confirmed*/ 100),
                    0
                  )
                )}
                ...
                className="mapCircle"
                radius={
                  (Math.log(wilaya.confirmed * 2) * 100000) / currentZoom
                }>
                <Popup>
                    ...
                    <div className="topToolTip">
                      ...
                      <div className="statLine">
                        ...
                        <div className="statCount confirmed font-bold">
                          <Odometer value={wilaya.confirmed} format="(,ddd)" />
                        </div>
                      </div>
