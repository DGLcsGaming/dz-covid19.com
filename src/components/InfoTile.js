...
function InfoTile() {
    ...
    const growthPercentage = useMemo(() => calcPercentage(currentStats, dailyStats), [currentStats, dailyStats]);
  ...
  return (
    <div className="infoTile">
        ...
        <div className="confirmedContainer">
            <div className="confirmed text-center"><Odometer value={currentStats.confirmed} format="(,ddd)" /></div>
        ...
        <div className="legend flex flex-row justify-center flex justify-center w-full md:justify-end md:mt-0">
            <div className="w-1/3 flex flex-col rounded overflow-hidden statshadow text-center text-yellow-600">
                <div className="h-16 pt-2 flex flex-auto items-center justify-center bg-yellow-100 text-xl lg:text-3xl font-bold font-sans"><span className="mx-2"><Odometer value={currentStats.active} format="(,ddd)" /></span></div>
            ...
            <div className="w-1/3 mx-2 flex flex-col rounded overflow-hidden statshadow text-center text-green-600">
                <div className="h-16 pt-2 flex flex-auto items-center justify-center bg-green-100 text-xl lg:text-3xl font-bold font-sans"><span className="mx-2"><Odometer value={currentStats.recovered} format="(,ddd)" /></span></div>
            ...
            <div className="w-1/3 flex flex-col rounded overflow-hidden statshadow text-center text-gray-600">
                <div className="h-16 pt-2 flex flex-auto items-center justify-center bg-gray-200 text-xl lg:text-3xl font-bold font-sans"><span className="mx-2"><Odometer value={currentStats.deaths} format="(,ddd)" /></span></div>
