  ...
  return (
    <div className="infoTile">
        ...
        <div className="legend flex flex-row justify-center flex justify-center w-full md:justify-end md:mt-0">
            ...
            <div className="w-1/3 mx-2 flex flex-col rounded overflow-hidden shadow text-center text-green-600">
            ...
            <div className="w-1/3 flex flex-col rounded overflow-hidden shadow text-center text-gray-600">
